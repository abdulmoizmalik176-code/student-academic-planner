    ...
    >
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h4 className="font-bold text-white text-xs">Daily Hydration Tracker</h4>
                <p className="text-[10px] text-slate-400">{waterCount} of 8 glasses logged today</p>
              </div>
            </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2 flex flex-col justify-between">
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider">Student Motivation</span>
            </div>
            <button
          ...
          <span className="text-[10px] text-slate-400 font-bold self-end">— {STUDENT_QUOTES[quoteIdx].author}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div 
          ...
          className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-indigo-500/50 cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400 font-medium">Tasks Today</span>
            <CheckCircle2 className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-xl font-bold text-white">{completedTasks.length}</span>
            <span className="text-xs text-slate-500">/ {todayTasks.length}</span>
          </div>
        </div>

        <div 
          onClick={() => onSelectTab('islamic')}
          className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-pink-500/50 cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400 font-medium">Namaz Logged</span>
            <span className="text-xs font-bold text-pink-400">🕌 Prayer</span>
          </div>
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-xl font-bold text-white">{namazCount}</span>
        ...
        <div 
          onClick={() => onSelectTab('islamic')}
          className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-amber-500/50 cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400 font-medium">Quran Recitation</span>
            <BookOpen className="w-4 h-4 text-amber-400" />
          </div>
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-xl font-bold text-white">{quranDone ? 'Completed' : 'Pending'}</span>
          </div>
        </div>

        <div 
          onClick={() => onSelectTab('focus')}
          className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-purple-500/50 cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400 font-medium">Focus Timer</span>
            <Clock className="w-4 h-4 text-purple-400" />
          </div>
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-xl font-bold text-white">25m</span>
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <button
            ...
            className="p-3 rounded-xl bg-gradient-to-r from-indigo-900/50 to-purple-900/50 hover:from-indigo-800/60 hover:to-purple-800/60 border border-indigo-700/50 text-left flex items-center justify-between group transition-all"
          >
            <div>
              <p className="text-xs font-bold text-white group-hover:text-indigo-300">AI Quiz Generator</p>
              <p className="text-[10px] text-indigo-300/70">Create subject tests</p>
            </div>
          ...
          <button
            ...
            className="p-3 rounded-xl bg-slate-900 hover:bg-slate-800/80 border border-slate-800 text-left flex items-center justify-between group transition-all"
          >
            <div>
              <p className="text-xs font-bold text-white group-hover:text-purple-300">Exam Countdown</p>
              <p className="text-[10px] text-slate-400">Track study syllabus</p>
            </div>
          ...
          >
            <div>
              <p className="text-xs font-bold text-white group-hover:text-emerald-300">Class Timetable</p>
              <p className="text-[10px] text-slate-400">Schedule & rooms</p>
            </div>
          ...
          >
            <div>
              <p className="text-xs font-bold text-white group-hover:text-amber-300">Habit Heatmap</p>
              <p className="text-[10px] text-slate-400">Track streaks</p>
            </div>
      ...
      <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-400">Prioritized tasks for your study & personal targets</p>
          </div>
          <button
            onClick={() => onSelectTab('tasks')}
        ...
        {todayTasks.length === 0 ? (
          <div className="p-8 text-center bg-slate-950/50 rounded-xl border border-dashed border-slate-800">
            <p className="text-xs text-slate-400 font-medium">All tasks complete for today! Great job! 🎉</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className={`text-sm font-semibold text-white ${isDone ? 'line-through text-slate-400' : ''}`}>
                        {task.name}
                      </p>
                      <div className="flex items-center gap-2 text-[11px] text-slate-400 mt-0.5">
                        <span className="font-medium text-indigo-300">{task.time}</span>
                        {task.subject && (
                  ...
                  <div className="text-right">
                    <span className="text-xs font-bold text-slate-300">{task.progress}%</span>
        ...
        <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {exams.map((exam) => {
              ...
              return (
                <div key={exam.id} className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-white truncate max-w-[120px]">{exam.subject}</span>
                  ...
                  <div>
                    <div className="flex justify-between text-[11px] text-slate-400">
                      ...
                      <span className="font-bold text-indigo-300">{exam.prep}%</span>
                    </div>
