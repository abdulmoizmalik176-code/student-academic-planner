    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Organize coursework, study targets, and daily routines</p>
        </div>
              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all ${
                  isDone
                    ...
                    : 'bg-slate-900 border-slate-800 hover:border-indigo-500/40 shadow-md'
                }`}
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="space-y-1 flex-1">
                      ...
                      {task.note && (
                        <p className="text-xs text-slate-400 line-clamp-2">{task.note}</p>
                      )}
                      ...
                      <div className="flex items-center gap-4 text-xs text-slate-400 pt-1">
                        ...
                        {task.recurring && (
                          <span className="text-[10px] font-bold text-purple-400">🔄 Daily Recurring</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold border border-slate-700"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-xs font-semibold border border-rose-500/20"
                    >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg p-6 space-y-4 shadow-2xl relative">
            ...
            <form onSubmit={handleCreateTask} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-slate-300 font-bold mb-1">Time Goal</label>
                  <input
                    type="text"
                    value={time}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-slate-300 font-bold mb-1">Est. Duration (Mins)</label>
                  <input
                    type="number"
              ...
              <div className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="w-4 h-4 rounded bg-slate-800 border-slate-700 accent-indigo-600"
                />
